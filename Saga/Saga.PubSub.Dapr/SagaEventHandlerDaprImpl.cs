...
namespace Saga.PubSub.Dapr
{
    public class SagaEventHandlerDaprImpl : ISagaEventHandler
    {
        ...
        {
            HttpContextExtension.ContextWapper.Value = new HttpContextWapper($"/SagaSubscribe/{ConfigurationManager.GetConfig().ServiceName}", context.RequestServices.GetService<ILifetimeScope>(), context);
            ...
            IocContainer.BuilderIocContainer(context.RequestServices.GetService<ILifetimeScope>());
