...
namespace Domain.Entities
{
    public class TradeLog : Entity, IAggregateRoot
    {
        ...
        public void CreateTradeLog(TradeLogState State, long orderId, string orderNo, long? logisticsId, string logisticsNo, long operateUserId, string operateUserName)
        {
