...
namespace Domain.Entities
{
    ...
    /// 领域实体
    /// </summary>
    public class Order : EntityAdd, IAggregateRoot
    {
        //订单号
        ...
        //创建订单
        public void CreateOrder(long userId, string consigneeName, string consigneeAddress, string consigneeTel, IEnumerable<OrderItem> orderItems)
        {
