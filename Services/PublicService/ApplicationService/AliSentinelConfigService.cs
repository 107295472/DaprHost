...
namespace ApplicationService
{
    public class AliSentinelConfigService : IAliSentinelConfigService
    {
        ...
        {
            var services = BaseCommon.GetRemoteServicesInfo();
            var controlBehavior = BaseCommon.GetEnumValue<ControlBehavior>().ToList();
            var strategy = BaseCommon.GetEnumValue<Strategy>().ToList();
